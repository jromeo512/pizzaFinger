        ...
        */
        ...
        private FingerprintResponse HandleAcquisitionError(int errorCode, string operation)
        {
            bool needsReinitialization =
                errorCode == zkfperrdef.ZKFP_ERR_NO_DEVICE ||
                errorCode == zkfperrdef.ZKFP_ERR_INVALID_HANDLE ||
                errorCode == zkfperrdef.ZKFP_ERR_CAPTURE ||
                errorCode == zkfperrdef.ZKFP_ERR_INIT ||
                errorCode == zkfperrdef.ZKFP_ERR_INITLIB ||
                errorCode == zkfperrdef.ZKFP_ERR_OPEN;

            string message = needsReinitialization
                ? "El lector se desconectó o está ocupado"
                : "No se detectó huella";
